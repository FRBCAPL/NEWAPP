...
export default function MatchProposalModal({
  ...
  style={{
    ...
    padding: "0.5em 1em",
    background: phase === "ladder" ? "#e53935" : "#222",
    color: "#fff",
    borderRadius: "6px",
    fontWeight: "bold",
    fontSize: "1.1em",
...
>
  {phase === "ladder" ? "Ladder Challenge Phase" : "Scheduled Match Phase"}
</div>
{phase === "ladder" && (
  <div style={{ color: "#fff", fontSize: "0.95em", marginBottom: "1em" }}>
    <em>
      Ladder matches have special rules. You can challenge up to 4 spots above, and match/defense limits apply.
    </em>
  </div>
)}
